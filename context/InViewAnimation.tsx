...
const defaultConfig: Required<
  Omit<InViewAnimationConfig, "onEnter" | "onExit">
> = {
  threshold: 0.1,
...
const InViewAnimationContext =
  createContext<InViewAnimationConfig>(defaultConfig);

export const useInViewAnimationConfig = () =>
  useContext(InViewAnimationContext);
